...
\begin{document}
	...
	\begin{abstract}
For decades, deformation monitoring based on the Global navigation satellite system (GNSS) has increasingly been important for a wide range of applications, from landslide monitoring, subsidence survey, to industrial measurement. 
...
Using the model designed above, Bayesian inference is implemented by MCMC sampling. 
