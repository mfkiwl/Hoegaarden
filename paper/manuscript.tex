...
\begin{abstract}
For decades, displacement detection base on the Global navigation satellite system (GNSS) has increasingly been important for a wide range of applications, from landslide monitoring, subsidence survey, to industrial measurement. 
...
\keywords{GNSS\and displacement detection \and Bayesian inference \and Markov Chain Monte Carlo \and real-time kinematic positioning}
