...
\section{Discussion}
\label{disc}
In the above experiment, due to the influence of observation noise, there are several significant peaks of posterior samples, and the posterior distribution of change points is close to each other. The interval between adjacent change points is constrained by adding an additional prior. The random variable $d\tau$, the distance between continuous change points, is added, which obeys the  discrete uniform distribution.
