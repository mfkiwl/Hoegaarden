...
In recent decades, GNSS has been widely used in navigation, surveying, and civil aviation as a positioning method. Besides, as a displacement detection method, GNSS has been applied to natural disaster monitoring, industrial measurement, and other fields. Compared with traditional displacement detection technology, GNSS-based displacement detection has many advantages, such as real-time, high accuracy, and weather independence.
